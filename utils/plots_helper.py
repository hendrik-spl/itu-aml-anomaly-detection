...
def plot_confusion_matrix(confusion_matrix: np.ndarray, labels, title: str, wandb) -> None:
...
def plot_smooth_error_distribution(x: np.ndarray, normal_density: np.ndarray, anomaly_density: np.ndarray, threshold: float, normal_peak_index: int, anomaly_peak_index: int, wandb) -> None:
    plt.figure(figsize=(8, 6))
